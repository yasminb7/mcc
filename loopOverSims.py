"""
Writes the columns "% of mesenchymals", "repetition number", etc. (see line 22) to a csv file (for all
simulations generated by the sim-file in constants.currentsim.
"""

...
percentage = sp.arange(0.0, 1.01, 0.4)
...
"get" : getConst,
"name" : "maze-medium_pM%s_q%s_r%s", #name of folder including %s for variables to be replaced according to "factors"
...
"q" : [0.4, 1.0],#sp.arange(1.0, 5.1, 1.0),
#"q" : [0.8],
"delta" : 0.3,
"mass" : 1,#5e-4,
